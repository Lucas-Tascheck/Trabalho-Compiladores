...
ListaFuncoes : ListaFuncoes Funcao {$$ = createFunc($1, $2);}
             ...
             | Funcao {$$ = $1;printf("%s", $1->tipo);}

             ;



Funcao : TipoRetorno ID TAPAR DeclParametros TFPAR BlocoPrincipal {$$ = initListaDeFunc("Func", $1, $2, $4);printf("%s", $1);}

       | TipoRetorno ID TAPAR TFPAR BlocoPrincipal {$$ = initListaDeFunc("Func", $1, $2, NULL);printf("teste");}
